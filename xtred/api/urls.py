...
from .views import (BannedListViewSet, BrandTypeViewSet,
                    ConstructionsCompanyViewSet, ConstructionsViewSet,
                    ConstructionsWorksViewSet, EntityViewSet, LocationViewSet,
                    ReminderViewSet, TelegramUserViewSet, UserViewSet)
