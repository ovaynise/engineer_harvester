...
from .forms import (ConstructionsForm,
                    ConstructionsCompanyForm,
                    ConstructionsWorksForm,
                    BrandTypeForm,
                    LocationForm)
...
class ConstructionsDetailView(LoginRequiredMixin,DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        all_companies = (ConstructionsCompany.objects.
                         filter(constructions_company=current_construction))
        ...
        works_list = ConstructionsWorks.objects.filter(
            constructions=current_construction)
        paginator_comments = Paginator(comments_list,
                                       3)
        ...
        context[
            'paginator_comments'] = paginator_comments
        context[
            'paginator_works'] = paginator_works

        return context


class ConstructionsDeleteView(
    OnlyAuthorAndAdminMixin,
    LoginRequiredMixin,
    DeleteView
):
    model = Constructions
